...
class faculty(models.Model):
	options=(('y',"yes"),('n','no'))
	depts=(('ise','information science'),('eee','electrical'),('cse','computer science'),('ece',"electronics and communication"))
...
class exam(models.Model):
	...
	semester=models.CharField(max_length=10,choices=semesters,default='5')
...
class tt(models.Model):
	depts=(('cse','CSE'),('ise','ISE'),('eee','EEE'),('ece',"ECE"))
...
class seating(models.Model):
	room=models.ForeignKey(room, on_delete=models.CASCADE)
	first_roll=models.CharField(max_length=10,null=False)
	last_roll=models.CharField(max_length=10,null=False)
